...
vec3f vec3f_lookat_rot(vec3f cur_rot, vec3f look_pt); // returns an offset vector for current rotation vector cur_rot so that (1, 0, 0) points towards look_pt from (0, 0, 0)
