...
libvoxel_rts.a: more_math.o math/collision.o math/hexahedron.o math/box.o math/vec.o math/mat.o math/quat.o math/body.o
...
math/hexahedron.o: math/hexahedron.c math/hexahedron.h math/body.h
	$(CCO) $< -o $@
math/box.o: math/box.c math/box.h math/body.h
	$(CCO) $< -o $@
